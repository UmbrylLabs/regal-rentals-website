...
export async function onRequest(context) {
  ...
  // Older cache-busting rules attached Clear-Site-Data to the static HTML.
  // Carrying that header through the Worker forced mobile browsers to erase
  // and redownload every site asset on every rentals-page visit.
